...
TEST_CASE("Testing the Message class.")
{
  ...
  std::cout<<message_content_string_json.getTypeName()<<" "
            <<message_content_string_json.getTypeValue()<<" "
            <<message_content_string_json.getContent()<<" "
            <<message_content_string_json.getTime()<<" "<<message_content_string_json.getTimestamp()<<std::endl;
}
