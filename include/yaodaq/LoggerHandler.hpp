...
public:
  ...
  void                            clearSinks();
  // Logs
  template<typename... Args> inline void log(const LogLevel& level, fmt::string_view str, const Args&... args)
  {
    printLog(level,fmt::format(str,args...));
  }
  template<typename... Args> inline void log(fmt::string_view str, const Args&... args)
  {
    printLog(LogLevel::Info,fmt::format(str,args...));
  }
